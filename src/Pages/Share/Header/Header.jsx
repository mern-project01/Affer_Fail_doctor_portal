...
const Header = () => {
  const { User, Handle_Log_Out } = useContext(AuthContext);
  ...
  const UlItem = (
    <>
      ...
      <li>
        {" "}
        <NavLink to="/contact">ContucUs</NavLink>{" "}
      </li>
      <li>
        {" "}
    ...
    <div className="">
      <div className="navbar  -mt-7 mb-4 bg-base-100 shadow-">
        ...
        <div className="navbar-end">
          ...
          {User ? (
            <details>
              <summary>{User ? User?.displayName : ""}</summary>
              <ul className="bg-base-100 rounded-t-none p-2">
                <li>
                  <a className="btn"> 
                    Profile{User ? User?.displayName : User?.email}{" "}
                  </a>
                </li>
                <li>
